...
#define REG_BG2X *(unsigned int *)0x4000028
#define REG_BG2Y *(unsigned int *)0x400002C
...
{
    pMatrix->nX1 = 1; pMatrix->nY1 = 0; pMatrix->nW1 = 0;
    pMatrix->nX2 = 0; pMatrix->nY2 = 1; pMatrix->nW2 = 0;
    pMatrix->nX3 = 0; pMatrix->nY3 = 0; pMatrix->nW3 = 1;
}

void Identity_FP_24_8(M2* pMatrix)
{
    pMatrix->nX1 = 1<<8; pMatrix->nY1 = 0; pMatrix->nW1 = 0;
    pMatrix->nX2 = 0; pMatrix->nY2 = 1<<8; pMatrix->nW2 = 0;
    pMatrix->nX3 = 0; pMatrix->nY3 = 0; pMatrix->nW3 = 1<<8;
}

void Identity_FP_16_16(M2* pMatrix)
{
    pMatrix->nX1 = 1<<16; pMatrix->nY1 = 0; pMatrix->nW1 = 0;
    pMatrix->nX2 = 0; pMatrix->nY2 = 1<<16; pMatrix->nW2 = 0;
    pMatrix->nX3 = 0; pMatrix->nY3 = 0; pMatrix->nW3 = 1<<16;
}
...
{
    pMatrix->nX1 = g_nCos_FP_16_16[nDegree];
    pMatrix->nY1 = g_nSin_FP_16_16[nDegree];
    pMatrix->nX2 = -g_nSin_FP_16_16[nDegree];
    pMatrix->nY2 = g_nCos_FP_16_16[nDegree];
}
...
{
	REG_BG2PA = pMatrix->nX1;
	REG_BG2PB = pMatrix->nY1;
	REG_BG2PC = pMatrix->nX2;
	REG_BG2PD = pMatrix->nY2;
	REG_BG2X = pMatrix->nW1;
	REG_BG2Y = pMatrix->nW2;
}